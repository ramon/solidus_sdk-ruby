...
# Unit tests for SolidusSdk::ListUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SolidusSdk::ListUsers200Response do
  let(:instance) { SolidusSdk::ListUsers200Response.new }

  describe 'test an instance of ListUsers200Response' do
    it 'should create an instance of ListUsers200Response' do
      expect(instance).to be_instance_of(SolidusSdk::ListUsers200Response)
    end
  end
