...
# Unit tests for SolidusSdk::StockLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SolidusSdk::StockLocation do
  let(:instance) { SolidusSdk::StockLocation.new }

  describe 'test an instance of StockLocation' do
    it 'should create an instance of StockLocation' do
      expect(instance).to be_instance_of(SolidusSdk::StockLocation)
    end
  end
