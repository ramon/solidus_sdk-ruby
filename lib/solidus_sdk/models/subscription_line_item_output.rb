...
module SolidusSdk
  class SubscriptionLineItemOutput
    ...
    attr_accessor :subscribable_id

    attr_accessor :id

    attr_accessor :spree_line_item_id
    ...
    def self.attribute_map
      {
        ...
        :'id' => :'id',
        :'spree_line_item_id' => :'spree_line_item_id',
    ...
    def self.openapi_all_of
      ...
      :'SubscriptionLineItemOutputAllOf'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SolidusSdk::SubscriptionLineItemOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SolidusSdk::SubscriptionLineItemOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subscribable_id')
        self.subscribable_id = attributes[:'subscribable_id']
      end
      ...
      if attributes.key?(:'spree_line_item_id')
        self.spree_line_item_id = attributes[:'spree_line_item_id']
      end
    ...
    def list_invalid_properties
      ...
      if @subscribable_id.nil?
        invalid_properties.push('invalid value for "subscribable_id", subscribable_id cannot be nil.')
      end
      ...
      if @spree_line_item_id.nil?
        invalid_properties.push('invalid value for "spree_line_item_id", spree_line_item_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subscribable_id.nil?
      return false if @id.nil?
      return false if @spree_line_item_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscribable_id == o.subscribable_id &&
          id == o.id &&
          spree_line_item_id == o.spree_line_item_id &&
    ...
    def hash
      [quantity, end_date, interval_length, interval_units, subscribable_id, id, spree_line_item_id, subscription_id, created_at, updated_at].hash
    end
