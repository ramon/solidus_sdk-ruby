...
module SolidusSdk
  class PatchSubscriptionsApiV1SubscriptionsIdRequestSubscription
    attr_accessor :line_items_attributes

    attr_accessor :shipping_address_attributes
    ...
    def self.openapi_types
      {
        :'line_items_attributes' => :'Array<SubscriptionLineItem>',
        :'shipping_address_attributes' => :'Object',
    ...
    def self.openapi_all_of
      [
      :'PatchSubscriptionsApiV1SubscriptionsIdRequestSubscriptionAllOf',
      :'Subscription'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SolidusSdk::PatchSubscriptionsApiV1SubscriptionsIdRequestSubscription` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SolidusSdk::PatchSubscriptionsApiV1SubscriptionsIdRequestSubscription`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipping_address_attributes')
        self.shipping_address_attributes = attributes[:'shipping_address_attributes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shipping_address_attributes == o.shipping_address_attributes &&
    ...
    def hash
      [line_items_attributes, shipping_address_attributes, billing_address_attributes, actionable_date, interval_units, interval_length, end_date].hash
    end
